...
#ifdef ZICIO
	int 		(*smgr_getfd) (SMgrRelation reln, ForkNumber forknum,
							  BlockNumber blocknum);	
#endif
...
#ifdef ZICIO
int
smgrgetfd(SMgrRelation reln, ForkNumber forknum, BlockNumber blocknum)
{
	return smgrsw[reln->smgr_which].smgr_getfd(reln, forknum, blocknum);
}
#endif
