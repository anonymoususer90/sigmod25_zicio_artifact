...
uint64_t buffer_wait_time = 0;
uint64_t seq_buffer_wait_time = 0;
uint64_t physical_io_time_with_buf = 0;
uint64_t physical_io_time_without_buf = 0;
uint64_t zicio_wait_time = 0;
