...
class Item_func_zicio_create_shared_pool final : public Item_str_func {
  String tmp_value;
    public:
  Item_func_zicio_create_shared_pool(const POS &pos, Item *a, Item *b, Item *c)
    : Item_str_func(pos, a, b, c) {
  }
  const char *func_name() const override {
    return "zicio_create_shared_pool";
  }
...
class Item_func_zicio_destroy_shared_pool final : public Item_str_func {
  String tmp_value;
    public:
  Item_func_zicio_destroy_shared_pool(const POS &pos, Item *a, Item *b, Item *c)
    : Item_str_func(pos, a, b, c) {}
  const char *func_name() const override {
    return "zicio_destroy_shared_pool";
  }
