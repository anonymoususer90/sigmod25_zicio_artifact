...
struct System_variables {
  ...
  */
  ...
  /**
    @sa Sys_zicio_shared_pool_num
	Force sequential scan through zicio channel shared pool if the pool number
  is valid
   */
  unsigned int zicio_shared_pool_num;

  /**
    @sa Sys_enable_zicio_stat
	Force stat for zicio evaluation
   */
  bool enable_zicio_stat;
};
