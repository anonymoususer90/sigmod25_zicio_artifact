...
typedef struct stopwatch_t {
  ...
  ulonglong global_elapsed_io_time;
  ulonglong scan_elapsed_io_time;
  ulonglong index_elapsed_io_time;
  ulonglong lookup_elapsed_io_time;

  ulonglong once_elapsed_io_time;
...
extern thread_local stopwatch_t stopwatch;
#endif /* __ZICIO_STAT */
#endif /* _my_sys_h */
