...
typedef struct HeapScanDescData
{
	TableScanDescData rs_base;	/* AM independent part of the descriptor */
  	...
  	struct zicio zicio;
	int zicio_init;
	void *zicio_chunk; 		/* 2 MiB chunk memory space from get_chunk */

	int fds[MAX_NUM_ZICIO_FD];	/* fd array pointer */
	int nr_fd;						/* # of fd */

	Page zicio_cdp;			/* page of current block */
#endif
...
extern void heap_setscanlimits(TableScanDesc scan, BlockNumber startBlk,
							   BlockNumber numBlks);
#ifdef ZICIO
extern void zicio_heapgetpage(TableScanDesc scan, BlockNumber page);
#endif
