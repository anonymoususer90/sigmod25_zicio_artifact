...
#ifdef CONFIG_ZICIO
asmlinkage long sys_zicio_u_open(unsigned int __user *fds, int nr_fd,
				unsigned long __user *addr, int stflg, int *device);
asmlinkage long sys_zicio_u_close(int id);
asmlinkage long sys_zicio_u_add_fds(int id, unsigned int __user *fds,
				int nr_fd);
asmlinkage long sys_zicio_u_dump_desc(int id);
asmlinkage long sys_zicio_u_dump_per_cpu(int cpu);
asmlinkage long sys_zicio_u_test(unsigned int id, unsigned __user * fds,
			int nr_fd, int req_size);
asmlinkage long sys_zicio_u_set_cpu_counter(unsigned int cpu_id);
asmlinkage long sys_zicio_u_dump_cpu(int cpu_id);
asmlinkage long sys_zicio_u_pread_breakdown_start(
				unsigned long __user *u_pread_stat);
asmlinkage long sys_zicio_u_pread_breakdown_end(void);
asmlinkage long sys_zicio_u_pread_breakdown_get_time(void);
#endif
