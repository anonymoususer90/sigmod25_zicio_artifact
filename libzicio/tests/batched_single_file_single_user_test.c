...
/* 
 * Batched data ingestion test - read 8 GiB from one 4 files
 */
int main(int argc, char *args[])
{
	...
	set_pages(&zicio, fd, 0, 3, &nr_page, page_nums);			// +4
	set_pages(&zicio, fd, 3, 7, &nr_page, page_nums);			// +5
	set_pages(&zicio, fd, 8, 11, &nr_page, page_nums);			// +4
	set_pages(&zicio, fd, 16, 19, &nr_page, page_nums);			// +4
	set_pages(&zicio, fd, 256, 511, &nr_page, page_nums);		// +256
	set_pages(&zicio, fd, 1024, 2047, &nr_page, page_nums);		// +1024
	set_pages(&zicio, fd, 262140, 262143, &nr_page, page_nums);	// +4
