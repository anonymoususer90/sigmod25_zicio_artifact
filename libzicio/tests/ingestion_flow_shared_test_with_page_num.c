...
static int do_data_ingestion(struct zicio *zicio)
{
	...
	char tsc_buffer[256];
	unsigned long read_data, data_sum = 0, sum = 0;
...
int main(int argc, char *args[])
{
	...
	sprintf(dir_path, "test_result_proc%d_page%d", num_process, num_pages);
